...
RUN_ID="search_5_20260530_092129"
OUTPUT_DIR="ckpts/ckpt_msrvtt_search_5_20260530_092129"

CUDA_VISIBLE_DEVICES="1,2" \
    torchrun --nproc_per_node=2 --master_addr=127.0.0.9 --master_port=43871 \
    ...
    --experiment_desc "search_trial_5"
