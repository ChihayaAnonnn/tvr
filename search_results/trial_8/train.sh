...
RUN_ID="search_8_20260531_110009"
OUTPUT_DIR="ckpts/ckpt_msrvtt_search_8_20260531_110009"

CUDA_VISIBLE_DEVICES="1,2" \
    torchrun --nproc_per_node=2 --master_addr=127.0.0.9 --master_port=42873 \
    ...
    --experiment_desc "search_trial_8"
