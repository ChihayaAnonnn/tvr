...
RUN_ID="search_3_20260529_190459"
OUTPUT_DIR="ckpts/ckpt_msrvtt_search_3_20260529_190459"

CUDA_VISIBLE_DEVICES="1,2" \
    torchrun --nproc_per_node=2 --master_addr=127.0.0.9 --master_port=50065 \
    ...
    --experiment_desc "search_trial_3"
