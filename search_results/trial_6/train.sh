...
RUN_ID="search_6_20260530_173129"
OUTPUT_DIR="ckpts/ckpt_msrvtt_search_6_20260530_173129"

CUDA_VISIBLE_DEVICES="1,2" \
    torchrun --nproc_per_node=2 --master_addr=127.0.0.9 --master_port=60223 \
    ...
    --experiment_desc "search_trial_6"
