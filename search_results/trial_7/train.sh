...
RUN_ID="search_7_20260531_021852"
OUTPUT_DIR="ckpts/ckpt_msrvtt_search_7_20260531_021852"

CUDA_VISIBLE_DEVICES="1,2" \
    torchrun --nproc_per_node=2 --master_addr=127.0.0.9 --master_port=49425 \
    ...
    --experiment_desc "search_trial_7"
