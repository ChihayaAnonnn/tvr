...
RUN_ID="search_1_20260529_010922"
OUTPUT_DIR="ckpts/ckpt_msrvtt_search_1_20260529_010922"

CUDA_VISIBLE_DEVICES="1,2" \
    torchrun --nproc_per_node=2 --master_addr=127.0.0.9 --master_port=57263 \
    ...
    --experiment_desc "search_trial_1"
