...
RUN_ID="search_2_20260529_082645"
OUTPUT_DIR="ckpts/ckpt_msrvtt_search_2_20260529_082645"

CUDA_VISIBLE_DEVICES="1,2" \
    torchrun --nproc_per_node=2 --master_addr=127.0.0.9 --master_port=42223 \
    ...
    --experiment_desc "search_trial_2"
