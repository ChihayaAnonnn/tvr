...
RUN_ID="search_0_20260528_155329"
OUTPUT_DIR="ckpts/ckpt_msrvtt_search_0_20260528_155329"

CUDA_VISIBLE_DEVICES="1,2" \
    torchrun --nproc_per_node=2 --master_addr=127.0.0.9 --master_port=36049 \
    ...
    --experiment_desc "search_trial_0"
